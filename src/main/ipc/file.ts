...
import type { OpenDialogOptions, SaveDialogOptions, FileResult } from '../../types/electron';
...
export function registerFileHandlers(): void {
  ...
  // 写入文件
  ipcMain.handle('file:write', async (_event, filePath: string, content: string): Promise<FileResult> => {
    try {
